...
HD_PWD='D:/KRIA/KRIA_KV260_DMA/KRIA_KV260_DMA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log KRIA_KV260_DMA_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source KRIA_KV260_DMA_wrapper.tcl
