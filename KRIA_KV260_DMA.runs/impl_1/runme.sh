...
HD_PWD='D:/KRIA/KRIA_KV260_DMA/KRIA_KV260_DMA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log KRIA_KV260_DMA_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source KRIA_KV260_DMA_wrapper.tcl -notrace
